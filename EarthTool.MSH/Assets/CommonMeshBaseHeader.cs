...
namespace EarthTool.MSH.Assets
{
  ...
  public sealed class CommonMeshBaseHeader
  {
      ...
      AnimationClassBytes animationLengths)
    {
      ...
      BinaryPrimitives.WriteUInt32LittleEndian(serializedRepresentation.AsSpan(0x08), (uint)meshKind);
      ...
      for (var attachment = 0; attachment < 49; attachment++)
      {
        ...
        BinaryPrimitives.WriteInt16LittleEndian(serializedRepresentation.AsSpan(offset), short.MinValue);
        BinaryPrimitives.WriteInt16LittleEndian(serializedRepresentation.AsSpan(offset + 2), short.MinValue);
        BinaryPrimitives.WriteInt16LittleEndian(serializedRepresentation.AsSpan(offset + 4), short.MinValue);
      }
