...
## Corpus Check
- 364 files · ~291,813 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4665 nodes · 13985 edges · 183 communities (172 shown, 11 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 917 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `27c571de`
...
- MeshAsset
- EarthTool.MSH/HostExtensions.cs
- package.json
...
1. `GltfWalkingSkeletonTests` - 224 edges
2. `GltfInterchange` - 188 edges
...
## Communities (183 total, 11 thin omitted)
...
### Community 2 - "Runner"
Cohesion: 0.15
Nodes (14): AssetResult, ChannelReader, ChannelWriter, DiagnosticKey, DynamicCoverage, Guid, IEnumerable, Task (+6 more)
...
Cohesion: 0.08
Nodes (7): Fact, Guid, Task, BlenderOutputEvidence, GltfWalkingSkeletonTests, Action, JsonArray
...
Cohesion: 0.09
Nodes (13): BinaryWriter, float, Matrix4x4, MemoryStream, Quaternion, Translation, Vector3, AttachmentHeadingProjection (+5 more)

### Community 14 - "MshOperationProfile"
Cohesion: 0.11
Nodes (21): DecodedStaticRecord, MeshAssetLineageId, MeshAssetOrigin, CancellationToken, Guid, IEnumerable, int, IReadOnlyDictionary (+13 more)
...
Cohesion: 0.13
Nodes (11): Vector3, DynamicEffectEvaluationContext, DynamicEffectSemantics, DynamicFrameSelection, DynamicSemanticFailure, DynamicTextureRegion, ReadOnlySpan, DynamicEffectExtension (+3 more)
...
### Community 18 - "CanonicalMeshAuthoringTests"
Cohesion: 0.20
...
Cohesion: 0.07
Nodes (20): DateTime, int, long, string, ArchiveInfoViewModel, ArchiveItemViewModel, bool, HashSet (+12 more)
...
Cohesion: 0.18
Nodes (14): EarthTool.MSH.Services, EarthTool.MSH.Authoring, EarthTool.MSH.Internal, EarthTool.MSH.Operations, EarthTool.GLTF, EarthTool.CLI.Commands.MSH, EarthTool.MSH, EarthTool.Consumer.Tests (+6 more)
...
### Community 34 - ".IsFinite"
Cohesion: 0.13
Nodes (9): GltfNewModelStaticLightOptions, Action, BinaryWriter, Quaternion, Translation, Vector3, NewModelSourceDraft, ParsedGltfLight (+1 more)
...
Cohesion: 0.07
Nodes (33): Guid, IReadOnlyDictionary, IReadOnlyList, string, GltfAnimationHandle, GltfArtistObjectLocalIds, GltfDiagnosticCodes, GltfDynamicEditImportResult (+25 more)

### Community 37 - "StaticMeshEditSession"
Cohesion: 0.13
Nodes (12): StaticRenderObjectId, bool, Dictionary, ICollection, IEnumerable, int, Matrix4x4, Vector3 (+4 more)

### Community 38 - "ArchiverServiceTests"
Cohesion: 0.21
Nodes (5): DateTime, Guid, Fact, string, ArchiverServiceTests

### Community 40 - "IDisposable"
Cohesion: 0.11
Nodes (15): Type, CommandTypeResolver, ReadOnlyMemory, IArchiveDataSource, int, MemoryMappedFile, ReadOnlyMemory, MappedArchiveDataSource (+7 more)
...
Cohesion: 0.07
Nodes (14): AnimationReplacement, IReadOnlyDictionary, OperationDiagnostic, ICollection, IEnumerable, JsonNode, JsonObject, Path (+6 more)
...
Cohesion: 0.17
Nodes (9): ContentFingerprint, BinaryWriter, IReadOnlyList, Vector3, ContentFingerprint, DiagnosticKey, OfficialCorpusQualification, OperationCounts (+1 more)

### Community 54 - "IReadOnlyList"
Cohesion: 0.10
Nodes (26): ImportPlanException, DynamicMetadataIdentityException, IReadOnlyList, ByteArrayComparer, GeometryPartition, MalformedMetadataException, MetadataAnimationClass, MetadataAnimationProjection (+18 more)

### Community 55 - "StaticMeshAsset"
Cohesion: 0.07
Nodes (38): Discarded, IDictionary, IReadOnlyCollection, IReadOnlyDictionary, IReadOnlyList, ISet, List, Matrix4x4 (+30 more)
...
Cohesion: 0.07
Nodes (27): DynamicEditedPreview, DynamicRecordSlice, float, IDictionary, int, JsonElement, ReadOnlySpan, Stream (+19 more)
...
### Community 68 - ".Write_And_Read_AreSymmetric"
Cohesion: 0.29
...
### Community 74 - "EarthTool.CLI.Commands.WD"
Cohesion: 0.24
Nodes (7): Command, EarthTool.CLI.Commands.WD, CancellationToken, CommandContext, ListCommand, WdCommandBase, ListSettings

### Community 75 - "CanonicalTriangle"
Cohesion: 0.11
Nodes (12): HashSet, IReadOnlyList, List, Vector2, AuthoringValidation, CanonicalHorizontalExtents, CanonicalStaticRenderObject, CanonicalStaticSourceObject (+4 more)

### Community 76 - "IReadOnlyList"
Cohesion: 0.13
Nodes (17): DynamicEffectPreview, DynamicObjectScope, DynamicSceneLayout, CancellationToken, GltfOperationProfile, ICollection, IEnumerable, InterchangeBaseline (+9 more)
...
Cohesion: 0.04
Nodes (36): EarthTool.WD.GUI.ViewModels, EarthTool.WD.Tests, EarthTool.Common.Enums, EarthTool.Common.Interfaces, EarthTool.WD.Tests.Factories, EarthTool.TEX, EarthTool.Common, EarthTool.WD.GUI (+28 more)
...
Cohesion: 0.11
Nodes (13): AnimationLayout, Action, GltfArtistObjectLocalIds, IEnumerable, InterchangeBaseline, IReadOnlyDictionary, NativeProjectionFingerprint, Utf8JsonWriter (+5 more)
...
### Community 84 - "ParameterReaderTests.cs"
Cohesion: 0.21
...
Cohesion: 0.09
Nodes (17): byte, Guid, IReadOnlyList, Matrix4x4, Vector3, AnimationClassBytes, CommonMeshBaseHeader, MeshArchiveFraming (+9 more)
...
### Community 137 - "ParsedGltfAnimationChannel"
Cohesion: 0.36
...
Cohesion: 0.20
Nodes (7): Guid, IEnumerable, WalkingSkeletonConsumer, MshBuildResult, MshEditResult, IEnumerable, MshExpert
...
Cohesion: 0.09
Nodes (21): CanonicalStaticRecord, CanonicalStaticFootprint, CanonicalStaticVertex, StaticAnimationReplacement, Encoding, Guid, IEnumerable, int (+13 more)
...
### Community 172 - ".ValidateOwnedAccessor"
Cohesion: 0.33
...
- **Why does `EarthTool.Common.Enums` connect `EarthTool.Common.Interfaces` to `IValueConverter`, `IEarthInfo`, `FileType`, `EarthTool.MSH.Assets`?**
  _High betweenness centrality (0.148) - this node is a cross-community bridge._
- **Why does `CliFixture` connect `Task` to `IDisposable`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `EarthTool.MSH.Assets` connect `EarthTool.MSH.Assets` to `StaticMeshAsset.cs`, `MetadataConflictCollector`, `GltfContracts.cs`, `GltfCliReportOperation`, `DynamicGltfInterchangeTests`, `StaticAnimationProjection`, `DynamicEffectExtension`, `GltfInterchange.cs`, `IReadOnlyList`?**
...
- **Should `Runner` be split into smaller, more focused modules?**
  _Cohesion score 0.14879227053140096 - nodes in this community are weakly interconnected._
