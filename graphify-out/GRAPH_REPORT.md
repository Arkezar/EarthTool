...
## Corpus Check
- 364 files · ~295,637 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4705 nodes · 14256 edges · 189 communities (183 shown, 6 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 971 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `26d3f21f`
...
1. `GltfWalkingSkeletonTests` - 248 edges
...
### Community 6 - "StaticMeshAsset"
Cohesion: 0.09
Nodes (23): Discarded, IDictionary, IReadOnlyDictionary, IReadOnlyList, ISet, List, AnimationReplacement, EmitterOwnershipPlan (+15 more)
...
Cohesion: 0.14
Nodes (11): ArchiveTestsBase, BinaryReader, DateTime, Guid, IEnumerable, ILogger, MemoryMappedFile, ArchiveFactory (+3 more)

### Community 16 - "DynamicEffectSemantics"
Cohesion: 0.16
Nodes (11): Vector3, DynamicEffectEvaluationContext, DynamicEffectSemantics, DynamicFrameSelection, DynamicSemanticFailure, DynamicTextureRegion, DynamicLightType, Fact (+3 more)
...
Cohesion: 0.07
Nodes (38): CliResult, EarthTool.MSH.Services, EarthTool.MSH.Authoring, EarthTool.MSH.Internal, EarthTool.MSH.Operations, EarthTool.GLTF, EarthTool.CLI.Commands.MSH, EarthTool.MSH (+30 more)
...
Cohesion: 0.10
Nodes (9): IReadOnlyDictionary, DiagnosticSeverity, OperationDiagnostic, GltfEditImportOptions, GltfMetadataConflictResolution, MetadataConflictResolutionResult, ParseScopeResolution, MetadataConflictResolutionResult (+1 more)

### Community 35 - ".RewriteStatic"
Cohesion: 0.19
Nodes (10): CanonicalStaticVertex, CanonicalTriangle, StaticRenderObjectAddition, IEnumerable, IReadOnlyDictionary, IReadOnlyList, ISet, ReadOnlySpan (+2 more)

### Community 36 - "InterchangeBaseline"
Cohesion: 0.12
Nodes (25): Guid, IReadOnlyDictionary, IReadOnlyList, string, GltfArtistObjectLocalIds, GltfDiagnosticCodes, GltfDynamicEditImportResult, GltfEditImportResult (+17 more)

### Community 37 - "StaticMeshEditSession"
Cohesion: 0.12
Nodes (13): StaticRenderObjectId, StaticSourceObject, bool, Dictionary, HashSet, IEnumerable, int, List (+5 more)
...
Cohesion: 0.07
Nodes (13): AnimationEditPlan, AnimationReplacement, Func, ICollection, IEnumerable, JsonNode, Path, ReadOnlySpan (+5 more)
...
Cohesion: 0.12
Nodes (9): GltfLightHandle, GltfMaterialHandle, GltfNewModelHorizontalExtents, GltfNewModelImportOptions, GltfNewModelStaticLightOptions, GltfNodeHandle, ISet, ParsedGlb (+1 more)
...
Cohesion: 0.06
Nodes (32): EntityClassType, bool, Dictionary, EditableEntity, bool, Dictionary, EditableResearch, Action (+24 more)

### Community 48 - "ParFile"
Cohesion: 0.10
Nodes (17): Task, IParFileService, ILogger, Task, ParFileService, Action, HashSet, IEnumerable (+9 more)
...
Cohesion: 0.15
Nodes (14): InterchangeBaseline, IReadOnlyDictionary, IReadOnlyList, NativeProjectionFingerprint, GeometryPartition, GltfPackage, ParsedGltfPrimitive, ProjectedPartition (+6 more)

### Community 55 - ".ReconcileStaticLights"
Cohesion: 0.13
Nodes (12): Action, BinaryWriter, IReadOnlyCollection, Matrix4x4, Quaternion, Translation, Vector3, NewModelSourceDraft (+4 more)
...
Cohesion: 0.19
Nodes (3): Utf8JsonWriter, ReadOnlySpan, DynamicEffectExtension

### Community 62 - "EarthTool.PAR.Enums"
Cohesion: 0.08
Nodes (11): EarthTool.PAR.Tests.TestDoubles, EarthTool.PAR.Extensions, EarthTool.PAR.Tests.TestData, EarthTool.PAR.Tests.Services, EarthTool.PAR.Enums, EarthTool.PAR.Models.Abstracts, EarthTool.PAR.Tests.Models, EarthTool.PAR.Factories (+3 more)
...
### Community 64 - "TreeNodeViewModelBase"
Cohesion: 0.07
...
Cohesion: 0.10
Nodes (13): IReadOnlyList, Vector2, AuthoringValidation, CanonicalHorizontalExtents, CanonicalStaticFootprint, CanonicalStaticObjectRole, CanonicalStaticRenderObject, CanonicalStaticSourceObject (+5 more)
...
Cohesion: 0.04
Nodes (37): EarthTool.WD.GUI.ViewModels, EarthTool.WD.Tests, EarthTool.Common.Enums, EarthTool.Common.Interfaces, EarthTool.WD.Tests.Factories, EarthTool.TEX, EarthTool.PAR, EarthTool.PAR.Services (+29 more)
...
Cohesion: 0.08
Nodes (7): AnimationLengths, JsonElement, IReadOnlyList, Matrix4x4, Vector3, AnimationLengths, StaticAnimationMshFixture

### Community 82 - ".CreateJson"
Cohesion: 0.14
Nodes (5): GltfArtistObjectLocalIds, IEnumerable, Utf8JsonWriter, EmitterActive, MarkerRecordCount
...
### Community 84 - "SourceObjectId"
Cohesion: 0.11
Nodes (6): PartitionMatch, UnchangedEmitterOwnership, SourceObjectId, IDictionary, RewrittenStaticRecord, StaticSourceBuilder
...
Cohesion: 0.19
Nodes (4): IEnumerable, Utf8JsonWriter, GltfCliReportOperationKind, GltfCliReportSerializer

### Community 95 - ".Decode"
Cohesion: 0.18
Nodes (10): DecodedStaticRecord, MeshAssetOrigin, CancellationToken, Guid, IEnumerable, IReadOnlyList, MshDecodeResult, StaticHierarchy (+2 more)

### Community 96 - "INotificationService"
Cohesion: 0.09
...
Cohesion: 0.17
Nodes (12): byte, IReadOnlyList, Matrix4x4, Vector3, AnimationClassBytes, CommonMeshBaseHeader, StaticAnimationClass, StaticAnimationTracks (+4 more)
...
Cohesion: 0.10
Nodes (13): Type, CommandTypeResolver, ReadOnlyMemory, IArchiveItem, HashSet, TextFlagService, bool, ReadOnlyMemory (+5 more)
...
Cohesion: 0.16
Nodes (12): Reader, FileType, IReader, BinaryReader, Encoding, IEnumerable, ParameterReader, IEnumerable (+4 more)

### Community 117 - "TexPreview"
Cohesion: 0.31
Nodes (5): Exception, PreviewResolution, TexPreview, PreviewResolution, PreviewResolutionKind
...
Cohesion: 0.11
Nodes (3): Action, Guid, OneTriangleMshFixture
...
Cohesion: 0.07
Nodes (28): DateTime, Encoding, IReadOnlyCollection, IArchive, DateTime, Guid, IArchiveFactory, Stream (+20 more)
...
Cohesion: 0.20
Nodes (6): AnimationLayout, MemoryStream, PartitionLayout, PartitionLayout, PreviewLayout, ProjectedPartition

### Community 134 - "ITransactionalFileSystem"
Cohesion: 0.19
...
### Community 156 - "MeshAsset"
Cohesion: 0.31
Nodes (4): Action, Func, MeshAsset, MeshAssetKind

### Community 158 - "MshCanonicalSerializer"
Cohesion: 0.14
Nodes (8): CanonicalStaticRecord, MeshArchiveFraming, Encoding, Guid, int, List, Matrix4x4, MshCanonicalSerializer
...
Cohesion: 0.24
Nodes (6): Func, IEnumerable, IReadOnlyList, SafeResourceLookup, SafeResourceMatch, TexResolutionBudget
...
### Community 177 - "PreservationChange"
Cohesion: 0.60
Nodes (3): ICollection, PreservationChange, PreservationDisposition

### Community 179 - "GltfWalkingSkeletonTests"
Cohesion: 0.08
Nodes (10): Action, Guid, IReadOnlyList, JsonDocument, JsonObject, List, Vector3, BlenderOutputEvidence (+2 more)
...
Cohesion: 0.12
Nodes (17): DynamicMetadataIdentityException, int, string, MalformedMetadataException, MetadataAnimationClass, MetadataAnimationProjection, MetadataPartition, MetadataSourceProvenance (+9 more)

### Community 184 - "IExtractor"
Cohesion: 0.33
Nodes (3): Task, IExtractor, IWDExtractor

### Community 185 - "EarthTool.WD.GUI"
Cohesion: 0.29
...
- **Why does `EarthTool.Common.Enums` connect `EarthTool.Common.Interfaces` to `IValueConverter`, `IEarthInfo`, `ParameterReader`, `EarthTool.MSH.Assets`?**
...
- **Why does `EarthTool.MSH.Assets` connect `EarthTool.MSH.Assets` to `StaticMeshAsset.cs`, `MetadataConflictCollector`, `InterchangeBaseline`, `MeshAssetAuthoring.cs`, `DynamicGltfInterchangeTests`, `StaticAnimationProjection`, `DynamicEffectSemantics`, `MshOperationProfile`, `GlbDocument.cs`?**
