# Graph Report - EarthTool2  (2026-08-04)

## Corpus Check
- 363 files · ~298,356 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4714 nodes · 14296 edges · 182 communities (175 shown, 7 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 973 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0198517e`
...
Cohesion: 0.06
Nodes (32): Diagnostics, CancellationTokenSource, CancellingReadStream, Asset, CancellationToken, CancellationTokenSource, Exception, Fact (+24 more)
...
Cohesion: 0.09
Nodes (22): DynamicEffectPreview, float, int, Stream, string, Translation, uint, Vector2 (+14 more)

### Community 6 - "IReadOnlyList"
Cohesion: 0.12
Nodes (16): IDictionary, IReadOnlyDictionary, IReadOnlyList, ISet, List, Matrix4x4, Quaternion, Translation (+8 more)
...
Cohesion: 0.08
Nodes (17): Action, BinaryWriter, float, int, Quaternion, string, Translation, Vector3 (+9 more)
...
Cohesion: 0.05
Nodes (34): BufferPath, ConflictKey, Directory, CancellationToken, Guid, IEnumerable, int, IReadOnlyDictionary (+26 more)
...
Cohesion: 0.12
Nodes (10): Task, bool, ILogger, object, ObservableCollection, ReactiveCommand, string, Task (+2 more)
...
Cohesion: 0.10
Nodes (15): Asset, byte, Bytes, CancellationToken, Fact, Guid, InlineData, IReadOnlyList (+7 more)
...
### Community 35 - "EarthTool.WD.GUI/App.axaml.cs"
Cohesion: 0.10
Nodes (12): EarthTool.WD.GUI, EarthTool.WD.GUI.Views, Task, MainWindow, AppBuilder, STAThread, Program, MainWindow (+4 more)
...
Cohesion: 0.11
Nodes (12): bool, Dictionary, ICollection, IEnumerable, int, Matrix4x4, MshEditResult, PreservationChange (+4 more)
...
Cohesion: 0.05
Nodes (21): AnimationEditPlan, AnimationReplacement, Action, BinaryWriter, Func, ICollection, IEnumerable, JsonNode (+13 more)
...
Cohesion: 0.07
Nodes (25): ViewModelBase, EntityClassType, bool, Dictionary, EditableEntity, bool, Dictionary, EditableResearch (+17 more)
...
Cohesion: 0.13
Nodes (20): AnimationLayout, Discarded, PartitionMatch, IReadOnlyList, MemoryStream, NativeProjectionFingerprint, ByteArrayComparer, GeometryPartition (+12 more)

### Community 55 - "IArchive"
Cohesion: 0.10
Nodes (12): Type, CommandTypeResolver, DateTime, Encoding, IReadOnlyCollection, IArchive, DateTime, Guid (+4 more)
...
Cohesion: 0.09
Nodes (11): EarthTool.PAR.Tests.TestDoubles, EarthTool.PAR.Extensions, EarthTool.PAR.Tests.TestData, EarthTool.PAR.Tests.Services, EarthTool.PAR.Enums, EarthTool.PAR.Models.Abstracts, EarthTool.PAR.Tests.Factories, EarthTool.PAR.Tests.Models (+3 more)
...
Cohesion: 0.09
Nodes (35): ImportPlanException, DynamicMetadataIdentityException, Guid, Projection, Version, MalformedMetadataException, MetadataAnimationClass, MetadataAnimationProjection (+27 more)
...
### Community 72 - ".Decode"
Cohesion: 0.17
Nodes (11): DecodedStaticRecord, MeshAssetOrigin, CancellationToken, Guid, IEnumerable, IReadOnlyList, DecodedStaticRecord, MshDecodeResult (+3 more)
...
Cohesion: 0.18
Nodes (4): HashSet, List, AuthoringValidation, Guid

### Community 76 - ".CreateStatic"
Cohesion: 0.16
Nodes (9): CanonicalStaticRecord, Guid, MeshArchiveFraming, CanonicalHorizontalExtents, CanonicalStaticFootprint, CanonicalStaticSourceObject, StaticMeshBuilder, List (+1 more)
...
Cohesion: 0.06
Nodes (20): EarthTool.WD.GUI.ViewModels, EarthTool.WD.Tests, EarthTool.Common.Enums, EarthTool.Common.Interfaces, EarthTool.WD.Tests.Factories, EarthTool.PAR.Services, EarthTool.Common, EarthTool.Common.Models (+12 more)

### Community 79 - "ArchiverService"
Cohesion: 0.16
...
Cohesion: 0.12
Nodes (12): GltfArtistObjectLocalIds, IEnumerable, InterchangeBaseline, IReadOnlyDictionary, Utf8JsonWriter, GltfPackage, StaticSourceObjectTraversal, StaticMeshAsset (+4 more)
...
### Community 84 - "INotificationService"
Cohesion: 0.17
Nodes (8): NotificationType, Exception, INotificationService, NotificationEventArgs, Exception, ILogger, NotificationService, EventArgs
...
Cohesion: 0.09
Nodes (20): Reader, Writer, FileType, IWriter, ILogger, Task, ParFileService, Encoding (+12 more)

### Community 88 - "ArchiveItem"
Cohesion: 0.18
Nodes (9): Stream, ICompressor, Encoding, bool, ReadOnlyMemory, ArchiveItem, Encoding, ArchiveTestsBase (+1 more)

### Community 89 - "EarthTool.WD.Services"
Cohesion: 0.19
Nodes (6): EarthTool.WD.Tests.Services, EarthTool.WD.Services, EarthTool.WD, EarthTool.WD.Factories, IServiceCollection, HostExtensions
...
Cohesion: 0.28
Nodes (6): Guid, WalkingSkeletonConsumer, MeshAssetLineageId, MshBuildResult, IEnumerable, MshExpert
...
### Community 95 - "CanonicalStaticVertex"
Cohesion: 0.18
Nodes (8): IEnumerable, IReadOnlyList, Vector2, Vector3, CanonicalStaticRenderObject, CanonicalStaticVertex, CanonicalTriangle, StaticRenderObjectAddition

### Community 96 - "EarthTool.Common.GUI.Enums"
Cohesion: 0.06
Nodes (23): EarthTool.Common.GUI.Enums, EarthTool.Common.GUI.Services, EarthTool.TEX.GUI, EarthTool.Common.GUI.Interfaces, EarthTool.Common.GUI.ViewModels, EarthTool.TEX.GUI.ViewModels, EarthTool.TEX.GUI.Views, EarthTool.Common.GUI (+15 more)

### Community 97 - "StaticRenderObjectId"
Cohesion: 0.11
Nodes (17): IReadOnlyCollection, StaticHierarchyPlan, UnchangedEmitterOwnership, SourceObjectId, StaticAnimationClass, StaticRenderObjectFlagMasks, StaticRenderObjectFlags, StaticRenderObjectId (+9 more)
...
Cohesion: 0.05
Nodes (24): EarthTool.PAR.GUI.Services, Action, DateTime, UndoAction, Action, IEnumerable, IUndoRedoService, Action (+16 more)

### Community 109 - "JsonElement"
Cohesion: 0.09
Nodes (15): DynamicRecordSlice, DynamicSceneLayout, CancellationToken, GltfOperationProfile, ICollection, IDictionary, ISet, JsonDocument (+7 more)
...
Cohesion: 0.10
Nodes (19): EarthTool.CLI.Commands.PAR, IDictionary, IEnumerable, JsonSerializerOptions, string, Task, ConvertCommand, CancellationToken (+11 more)
...
### Community 140 - "AnimationClassBytes"
Cohesion: 0.13
Nodes (5): NewModelAnimationSet, IReadOnlyList, AnimationClassBytes, CommonMeshBaseHeader, NewModelAnimationTrack
...
Cohesion: 0.10
Nodes (13): EarthTool.PAR, EarthTool.CLI, EarthTool.CLI.Commands, Func, IHostBuilder, ITypeResolver, Type, CommandTypeRegistrar (+5 more)
...
### Community 156 - "ListCommand"
Cohesion: 0.38
Nodes (4): CancellationToken, CommandContext, ListCommand, ListSettings

### Community 158 - "MshCanonicalSerializer"
Cohesion: 0.10
Nodes (20): byte, Matrix4x4, Vector3, StaticAnimationTracks, StaticRenderObject, StaticAnimationReplacement, Encoding, IEnumerable (+12 more)
...
Cohesion: 0.10
Nodes (11): EarthTool.PAR.GUI, AppBuilder, STAThread, Program, Control, ViewLocator, Control, ViewLocator (+3 more)
...
Cohesion: 0.06
Nodes (24): EarthTool.PAR.GUI.ViewModels, EarthTool.PAR.GUI.Models, EarthTool.PAR.GUI.Views, Encoding, IBinarySerializable, Faction, ResearchType, ObservableCollection (+16 more)
...
Cohesion: 0.12
Nodes (17): DynamicAnimationLayout, DynamicAnimationTrack, DynamicImageLayout, DynamicMeshLayout, DynamicObjectScope, BinaryWriter, IEnumerable, InterchangeBaseline (+9 more)
...
- **Why does `EarthTool.Common.Enums` connect `EarthTool.Common.Interfaces` to `IValueConverter`, `IEarthInfo`, `ParFile`, `EarthTool.CLI/Program.cs`, `EarthTool.MSH.Assets`?**
  _High betweenness centrality (0.151) - this node is a cross-community bridge._
- **Why does `CliFixture` connect `Task` to `GltfImportPlanSerializer`, `DynamicGltfInterchangeTests`, `IArchive`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **Why does `EarthTool.MSH.Assets` connect `EarthTool.MSH.Assets` to `StaticRenderObjectId`, `MetadataEnvelope`, `GltfContracts.cs`, `DynamicGltfInterchangeTests`, `StaticAnimationProjection`, `DynamicEffectExtension`, `GltfImportPlanSerializer`?**
...
- **Should `DynamicGltfDocument` be split into smaller, more focused modules?**
